  ...
  const socialLinks = [
    {
      icon: <Github size={20} />,
      name: 'GitHub',
      url: 'https://github.com/ankitnarang'
    },
    {
      icon: <Linkedin size={20} />,
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/ankitnarang'
    },
    {
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-200"
                >
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className="bg-white p-3 rounded-lg shadow-md hover:shadow-lg transition-all text-gray-600 hover:text-gray-900 border border-gray-200"
                    title={social.name}
                  >
                    {social.icon}
                  </motion.a>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gray-900 text-white py-3 px-6 rounded-lg hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 font-medium"
              >
                <Send size={20} />
                Send Message
              </motion.button>
